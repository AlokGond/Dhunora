...
fun LiquidGlassAppBottomNavigationBar(
    ...
    // A tab can disappear from the bar under the user: the YouTube session ends while Mix for you
    // is selected. Fall back to Home so nothing is left highlighted.
