...
/**
 * Selection state for a list of songs. Held by the screen, read by [com.alok.dhunora.ui.ui.component.SongFullWidthItems].
 *
...
fun rememberSongSelectionState(): SongSelectionState {
    val limitMessage = stringResource(R.string.max_selection_reached, MAX_SONG_SELECTION)
