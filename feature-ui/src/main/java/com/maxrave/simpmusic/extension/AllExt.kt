package com.alok.dhunora.ui.extension
...
import com.alok.dhunora.ui.viewModel.ArtistScreenData
...
fun LocalDateTime.formatTimeAgo(): String {
    ...
    return when {
        monthsDiff >= 1 -> stringResource(R.string.month_s_ago, monthsDiff)
        daysDiff >= 1 -> stringResource(R.string.day_s_ago, daysDiff)
        hoursDiff >= 2 -> stringResource(R.string.hour_s_ago, hoursDiff)
        else -> stringResource(R.string.recently)
    }
}

@Composable
fun formatDuration(duration: Long): String {
    if (duration < 0L) return stringResource(R.string.na_na)
...
fun FilterState.displayNameRes(): Int =
    when (this) {
        ...
        FilterState.CustomOrder -> R.string.custom_order
    }
