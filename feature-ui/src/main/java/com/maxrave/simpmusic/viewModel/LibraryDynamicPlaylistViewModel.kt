...
import com.alok.dhunora.ui.ui.screen.home.analytics.monthFullNameResource
...
class LibraryDynamicPlaylistViewModel(
    ...
    private suspend fun recapName(recap: LibraryDynamicPlaylistType.MonthlyRecap): String {
        val month =
            com.alok.dhunora.ui.compat.getString(monthFullNameResource(Month(recap.month)))
        return if (recap.year == now().date.year) {
            com.alok.dhunora.ui.compat.getString(R.string.wrapped_recap_month, month)
        } else {
            com.alok.dhunora.ui.compat.getString(R.string.wrapped_recap_month_year, month, recap.year.toString())
        }
    }
    ...
    private fun playlistName(type: LibraryDynamicPlaylistType): String {
        ...
        return "${getString(R.string.playlist)} $name"
    }
