 ...
 * [com.alok.dhunora.ui.ui.component.selection.SelectedSongsBottomSheet].
 *
...
class SongSelectionViewModel(
    ...
    fun addToPlaylist(
        ...
        viewModelScope.launch {
            ...
            toAdd.forEach { song ->
                localPlaylistRepository
                    .addTrackToLocalPlaylist(
                        ...
                        updatedYtMessage = getString(R.string.added_to_playlist),
            ...
            makeToast(
                if (added > 0) getString(R.string.added_to_playlist) else getString(R.string.error),
            )
        }
    }
    ...
    fun removeFromLocalPlaylist(
        ...
        viewModelScope.launch {
            ...
            songs.forEach { song ->
                localPlaylistRepository
                    .removeTrackFromLocalPlaylist(
                        id = playlistId,
                        song = song,
                        successMessage = getString(R.string.delete_song_from_playlist),
                        updatedYtMessage = getString(R.string.removed_from_YouTube_playlist),
            ...
            makeToast(getString(R.string.delete_song_from_playlist))
        }
    }
